var fightOrSkip = function() {
  ...
  // Conditional recursive function call (if the 'promptFight' is NOT a valid value, then execute the foloowing statements.)
  if (promptFight === "" || promptFight === null) {
    window.alert("You need to provide a valid answer! Please try again.");
    return fightOrSkip();
  }
// Converts prompt response to lowercase characters
...
var startGame = function() {
  // reset player stats, calling the method
  playerInfo.reset();
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // reset enemy.health to random value between (40 - 60) before starting new fight
...
var endGame = function() {
  ...
  // if player has more money then high score, player has new high score!
...
// Custom Player Object (parent object)
var playerInfo = {
name: getPlayerName(),
health: 100,
attack: 10,
...
// will display random decimal number between 0 - 1
console.log(Math.random());


// Make random whole numbers
//enemy.health = Math.floor(Math.random() * 60);
...
var food = {
 ...
 // Access the food object properties
 console.log(food.name); // "Bananna"
